function carregaDicionario() {
  let biografias = {
    ...
    bio02: {
      ...
      imagem: "./imagens/carolina-de-jesus.png",
    ...
    bio06: {
      ...
      imagem: "./imagens/nina-hora.png",

      descricao:

        "Ana Carolina Silva das Neves da Hora, a Nina da Hora, como é conhecida nas redes sociais, se tornou referência da nova geração de pesquisadores e cientistas ligados à tecnologia no País. A infância humilde na periferia de Duque de Caxias (RJ), longe das telas dos computadores, não a impediu de sonhar em trabalhar com computação e despontar como uma grande “hacker”. Pesquisadora do Centro de Tecnologia e Sociedade da Fundação Getúlio Vargas (CTS-FGV), colunista da revista MIT Technology Review, do tradicional instituto norte-americano, e integrante do Conselho de Segurança da rede social TikTok. Foi convidada para participar da Comissão de Transparência das Eleições no Tribunal Superior Eleitoral (TSE).",

      citacao:

        "Hackear, para mim, não está ligado só à computação, mas a hackear padrões, formatos, sempre em busca de algo mais coletivo e acessível"
    },
